      ...
      {(provided, snapshot) => (
        ...
        >
          <div
            ...
            className="rounded-xl cursor-pointer transition-all duration-150 animate-fade-in overflow-hidden"
            style={{
              backgroundColor: "#fff",
              opacity: dimmed ? 0.28 : 1,
              transform: snapshot.isDragging ? "rotate(1.5deg) scale(1.03)" : undefined,
              boxShadow: snapshot.isDragging
                ? "0 12px 32px rgba(9,30,66,0.22)"
                : "0 1px 0 rgba(9,30,66,0.14)",
            }}
            onMouseEnter={e => !snapshot.isDragging && (e.currentTarget.style.boxShadow = "0 3px 12px rgba(9,30,66,0.14)")}
            onMouseLeave={e => !snapshot.isDragging && (e.currentTarget.style.boxShadow = "0 1px 0 rgba(9,30,66,0.14)")}
          >
            {/* Cover strip */}
            {card.cover_color && (
